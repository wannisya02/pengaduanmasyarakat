        <div class="row">
        	<div class="col s12 m9">
        		<h3 class="darkgrey-text">User</h3>
        	</div>
        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($tampil)) { ?>
        			<tr>
        				...
        				<td><a class="btn green modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
