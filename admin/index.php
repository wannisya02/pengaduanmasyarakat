...
<div class="row">
	<div class="col s12 m3">
		<ul id="slide-out" class="sidenav sidenav-fixed">
			...
			<li><a href="index.php?p=registrasi"><i class="material-icons">featured_play_list</i>Masyarakat</a></li>
			<li><a href="index.php?p=pengaduan"><i class="material-icons">report</i>Pengaduan</a></li>
			<li><a href="index.php?p=respon"><i class="material-icons">chat</i>Respon</a></li>
			<li><a href="index.php?p=user"><i class="material-icons">person_pin</i>User</a></li>
