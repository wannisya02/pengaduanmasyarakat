<table class="responsive-table" border="2" style="width: 100%;">
	<tr>
		<td>
			<h4 class="grey-text hide-on-med-and-down">Tulis Laporan</h4>
		</td>
			...
			<form method="POST" enctype="multipart/form-data">
				<div class="row">
					<div class="input-field col s6">
						...
						<textarea id="icon_prefix2" class="materialize-textarea" name="laporan"></textarea>
						<label for="icon_prefix2">Tulis Laporan</label>
					</div>
				</div>
				<label>Gambar</label>
				<input type="file" name="foto"><br><br>
				<input type="submit" name="kirim" value="Kirim" class="btn grey">
			</form>
		</td>
